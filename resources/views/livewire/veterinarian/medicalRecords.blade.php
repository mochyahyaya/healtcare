...
<<<<<<< HEAD
                     ...
                     <section class="text-gray-600 body-font">
                       <div class="container px-5 py-19 mx-auto">
                         <div class="flex flex-col text-center w-full mb-10 mt-4">
                           <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Medical Record</h1>
                           <h3 class="sm:text-2xl text-1xl font-small title-font mb-4 text-gray-900">Semua Pengguna</h3>
                        </div>
...
<<<<<<< HEAD
                                  <img alt="team" class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="{{ $item->profile_photo_url }}" alt="" >
=======
