        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <ul class="navbar-nav mr-auto justify-center items-center lg:flex">
                    ...
                    <li class="nav-item">
                    <a class="page-scroll active" href="{{route('user/historyactivityhotels')}}">Boarding</a>
                    </li>
                    <li class="nav-item">
                    <a class="page-scroll" href="{{route('user/historyactivitybreeds')}}">Breeding</a>
                    </li>
                </ul>
                <div class="border-t border-gray-200"></div>
                <section class="text-gray-600 body-font overflow-hidden">
                    <div class="container px-5 py-12 mx-auto">
                      <div class="-my-8 divide-y-2 divide-gray-100">
                          @foreach ($historyBoardings as $item)
                          <div class="py-8 flex flex-wrap md:flex-nowrap">
                            <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                              <span class="font-semibold title-font text-gray-700">Boarding</span>
                              <span class="mt-1 text-gray-500 text-sm">{{$item->status}}</span>                            </div>
                            <div class="md:flex-grow">
                              ...
                              <div class="py-4 flex flex-wrap md:flex-nowrap">
                                <span class="mt-1 text-gray-500 text-sm">Masuk:{{ \Carbon\Carbon::parse($item->start_date)->translatedFormat('d F Y')}}</span>
                              </div>
                              <div class="py-4 flex flex-wrap md:flex-nowrap">
                                <span class="mt-1 text-gray-500 text-sm">Keluar:{{ \Carbon\Carbon::parse($item->end_date)->translatedFormat('d F Y')}}</span>
                              </div>
