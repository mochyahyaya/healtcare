        ...
        <div class="container h-screen px-5 py-24 mx-auto">
            <div class="bg-white shadow overflow-hidden border-b border-gray-200 sm:rounded-lg p-12">
                <div class="flex flex-col text-center w-full mb-20">
                    ...
                    <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Hewan Peliharaan Admin</p>
                </div>
                <a href="{{route('user/breedings')}}">
                    <button class="flex mt-16 mb-16 text-white bg-blue-300 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Book Pet</button>
                </a>
                <div class="flex flex-wrap -m-4">
                    @foreach ($adminPet as $item)
                    <div class="lg:w-1/4 sm:w-1/2 p-2 border-4 border-gray-200">
                        <div class="flex relative">
                            ...
                            <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                                ...
                                <a href= "{{route('user/userbreedinggalery', ['id'=>$item->id])}}" class="text-indigo-600 hover:text-indigo-900 mr-3">Lihat Galeri</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
